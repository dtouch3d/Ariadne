...
SET_TARGET_PROPERTIES(dynamorio PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib32/release/libdynamorio.so.4.2"
  IMPORTED_SONAME_RELEASE "libdynamorio.so.4.2"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS dynamorio )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_dynamorio "${_IMPORT_PREFIX}/lib32/release/libdynamorio.so.4.2" )
...
SET_TARGET_PROPERTIES(drutil_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrutil_static.a"
  )
...
SET_TARGET_PROPERTIES(drgui PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/bin32/drgui"
  )
...
SET_TARGET_PROPERTIES(drsyms_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrsyms_static.a"
  )
...
SET_TARGET_PROPERTIES(drwrap_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrwrap_static.a"
  )
...
SET_TARGET_PROPERTIES(drx_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrx_static.a"
  )
...
SET_TARGET_PROPERTIES(drmgr_static PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dynamorio"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/ext/lib32/release/libdrmgr_static.a"
  )
...
SET_TARGET_PROPERTIES(drltrace PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/lib32/release/libdrltrace.so"
  IMPORTED_SONAME_RELEASE "libdrltrace.so"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS drltrace )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_drltrace "${_IMPORT_PREFIX}/tools/lib32/release/libdrltrace.so" )
...
SET_TARGET_PROPERTIES(drcov PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/lib32/release/libdrcov.so"
  IMPORTED_SONAME_RELEASE "libdrcov.so"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS drcov )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_drcov "${_IMPORT_PREFIX}/tools/lib32/release/libdrcov.so" )
...
SET_TARGET_PROPERTIES(drcov2lcov PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/tools/bin32/drcov2lcov"
  )
