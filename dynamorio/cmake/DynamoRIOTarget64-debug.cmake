...
SET_TARGET_PROPERTIES(dynamorio PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib64/debug/libdynamorio.so.4.2"
  IMPORTED_SONAME_DEBUG "libdynamorio.so.4.2"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS dynamorio )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_dynamorio "${_IMPORT_PREFIX}/lib64/debug/libdynamorio.so.4.2" )
...
SET_TARGET_PROPERTIES(drgui PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/ext/bin64/drgui"
  )
...
SET_TARGET_PROPERTIES(drltrace PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/tools/lib64/debug/libdrltrace.so"
  IMPORTED_SONAME_DEBUG "libdrltrace.so"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS drltrace )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_drltrace "${_IMPORT_PREFIX}/tools/lib64/debug/libdrltrace.so" )
...
SET_TARGET_PROPERTIES(drcov PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/tools/lib64/debug/libdrcov.so"
  IMPORTED_SONAME_DEBUG "libdrcov.so"
  )

LIST(APPEND _IMPORT_CHECK_TARGETS drcov )
LIST(APPEND _IMPORT_CHECK_FILES_FOR_drcov "${_IMPORT_PREFIX}/tools/lib64/debug/libdrcov.so" )
...
SET_TARGET_PROPERTIES(drcov2lcov PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/tools/bin64/drcov2lcov"
  )
