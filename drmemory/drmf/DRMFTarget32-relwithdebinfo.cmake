...
set_target_properties(drsyscall PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsyscall.so.0.9.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsyscall.so.0.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsyscall.so.0.9.0" )
...
set_target_properties(drsymcache PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsymcache.so.0.9.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsymcache.so.0.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache "${_IMPORT_PREFIX}/drmf/lib32/release/libdrsymcache.so.0.9.0" )
...
set_target_properties(umbra PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib32/release/libumbra.so.0.9.0"
  IMPORTED_SONAME_RELWITHDEBINFO "libumbra.so.0.9.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra "${_IMPORT_PREFIX}/drmf/lib32/release/libumbra.so.0.9.0" )
